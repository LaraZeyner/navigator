...
public final class Messages {
  ...
  public static final String DISABLING = "Navigator fährt herunter...";
  public static final String ENABLING = "Navigator startet...";
  ...
  public static final String SUCCESSFULLY_DISABLED = "Navigator wurde erfolgreich heruntergefahren.";
  public static final String SUCCESSFULLY_ENABLED = "Navigator wurde erfolgreich gestartet.";

  // General
  public static final String PREFIX = "Navigator | ";
}
